    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?=site_url('buku');?>">Lihat Buku</a></li>
                <li class="divider"></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?=site_url('kategori');?>">Lihat Kategori</a></li>
                <li class="divider"></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
      			    <li><a href="<?=site_url('anggota');?>">Lihat Anggota</a></li>
                <li class="divider"></li>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            <li><a href="<?=base_url();?>logout.php"> <i class="fa fa-sign-out"></i> Keluar</a></li>
          </ul>
        </div>
        <!-- /.navbar-custom-menu -->
      </div>
